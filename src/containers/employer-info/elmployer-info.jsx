    ...
    if (avatar) {
        ...
        return (
            <div>
                ...
                <InputItem labelNumber={15} placeholder="Position" onChange={handleChange('position')}></InputItem>
                <InputItem placeholder="Company" onChange={handleChange('company')}></InputItem>
                <InputItem placeholder="Salary" onChange={handleChange('salary')} ></InputItem>
                <TextareaItem placeholder='Requirements' rows={3} onChange={handleChange('info')} />
